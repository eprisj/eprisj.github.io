...
const ROUTE_DESCRIPTIONS = {
  ...
  codex: 'Мануал для тех, кто ведёт исследование в искусстве: как превратить тему в вопрос, смотреть на вещь и работать с фрагментом, не смешать первоисточник с чужим выводом, разобрать корпус текстов, проверить цитаты, собрать и посчитать данные о собрании. Токены и цена простыми словами. Разборы на настоящих музейных данных, с адресами источников и библиотекой запросов.',
};
