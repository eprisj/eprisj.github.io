...
const ROUTE_DESCRIPTIONS = {
  ...
  codex: 'Мануал для тех, кто пишет и исследует искусство: как формулировать просьбу, проверять цитаты, кросс-валидировать, собирать и чистить данные, считать аналитику собрания и посещаемости. Разборы на настоящих музейных данных, с адресами источников и библиотекой запросов.',
};
