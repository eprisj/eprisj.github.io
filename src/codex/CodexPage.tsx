        ...
        {isLibrary ? (
          ...
          <>
            ...
            <section className="codex-open codex-title">
              ...
              {/* Слово «машина» стоит в имени серии и не стоит в изложении: оно
                  рабочее и пришло из редакционного обихода, а в тексте
                  инструмент называется тем, чем является. Оговорка нужна, иначе
                  расхождение заглавия и первой же страницы читается как
                  небрежность. */}
              <p className="terminology codex-mono">
                Терминология. «Машина» это рабочее слово редакции, вынесенное в имя серии.
                В изложении инструмент называется моделью, а работа с ним сеансом.
              </p>
