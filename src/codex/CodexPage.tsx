      ...
      <div className="codex-shell">
        ...
        {isLibrary ? (
          ...
          <>
            ...
            {/* Титульный лист набран в две колонки: слева заглавие и
                аннотация, справа выходные данные. Одна колонка на всю ширину
                оставляла правую половину экрана пустой, а служебные строки
                висели под аннотацией без всякой связи с ней. */}
            <section className="codex-open codex-title">
              ...
              <div className="cols">
                <div className="abstract">
                  ...
                  <p className="lead">
                    Материал рассчитан на архитектора и историка искусства, а не на
                    программиста. Устройство модели не разбирается нигде: разбирается
                    работа, ради которой к ней обращаются, то есть экспликация, каталожная
                    запись, подготовка к интервью, проверка цитаты, перевод на язык,
                    которым редактор не владеет, сборка номера.
                  </p>
                </div>

                <div className="meta">
                  <dl>
                    <dt className="codex-mono">Автор</dt>
                    <dd>{AUTHOR}</dd>
                    <dt className="codex-mono">Издающая сторона</dt>
                    <dd>Редакция EPRIS</dd>
                    <dt className="codex-mono">Серия</dt>
                    <dd>«{SERIES}», выпуск первый</dd>
                    <dt className="codex-mono">Издание</dt>
                    <dd>{CODEX_EDITION}</dd>
                    <dt className="codex-mono">Объём</dt>
                    <dd>{CHAPTERS.length} глав, {PROMPTS.length} образцов запросов</dd>
                  </dl>

                  {/* Слово «машина» стоит в имени серии и не стоит в изложении:
                      оно рабочее и пришло из редакционного обихода. Оговорка
                      нужна, иначе расхождение заглавия и первой же страницы
                      читается как небрежность. */}
                  <p className="terminology">
                    <span className="codex-mono lbl">Терминология. </span>
                    «Машина» это рабочее слово редакции, вынесенное в имя серии. В
                    изложении инструмент называется моделью, а работа с ним сеансом.
                  </p>

                  <p className="keywords codex-mono">
                    Ключевые слова: методика исследования · верификация ·
                    источниковедение · искусствознание · редакционная практика ·
                    языковые модели
                  </p>
                </div>
              </div>
