...
const OPENING_WORKS: FuturoshockWork[] = [
  ...
  { id: 'fs-opening-candleholders', title: 'brass candleholders', author: 'Tina / Poly Haven', year: '2022', format: '3d', medium: 'cast brass / GLB', statement: 'Three holders of different heights, kept as one work. They are the brightest metal in the room and the only piece that reads as a group rather than an object.', modelUrl: '/models/futuroshock/candleholders.glb', materials: ['cast brass', 'wax'], edition: 'shelf 13 / CC0', room: 'room-01', shelfSlot: 13, shelfScale: .78, textureNote: 'polished brass, specular ior' },
  { id: 'fs-opening-ceramic-vase', title: 'ceramic vase', author: 'James Ray Cock / Poly Haven', year: '2021', format: '3d', medium: 'photogrammetry / GLB', statement: 'A plain thrown vase with an even glaze, deliberately the quietest thing on the shelf. Everything sharper around it needs something to be measured against.', modelUrl: '/models/futuroshock/ceramic-vase.glb', materials: ['stoneware', 'even glaze'], edition: 'shelf 14 / CC0', room: 'room-01', shelfSlot: 14, shelfScale: .84, textureNote: 'even matte glaze' },
  { id: 'fs-opening-brass-vase', title: 'brass vase', author: 'Rico Cilliers / Poly Haven', year: '2021', format: '3d', medium: 'spun brass / GLB', statement: 'A spun brass body that holds the whole room in its surface: the shelf strip, the warm wall and whatever is standing next to it all arrive as reflections.', modelUrl: '/models/futuroshock/brass-vase.glb', materials: ['spun brass'], edition: 'shelf 15 / CC0', room: 'room-01', shelfSlot: 15, shelfScale: .82, textureNote: 'mirror brass, room reflections' },
