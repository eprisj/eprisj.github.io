...
function InteriorRoom({ compact = false, lightMode = 'warm' }: { compact?: boolean; lightMode?: LightMode }) {
  return (
    <div className={`relative isolate overflow-hidden bg-[#201a17] ${compact ? 'min-h-[360px]' : 'min-h-[560px]'}`}>
      <img src="/images/futuroshock-interior.png" alt="The Futuroshock interior, prepared for its first works" className={`absolute inset-0 h-full w-full object-cover object-center transition duration-700 ${lightMode === 'contrejour' ? 'scale-[1.02] saturate-[.42] contrast-[1.28] brightness-[.56]' : 'saturate-[.72] contrast-[1.04]'}`} />
      ...
      <div className={`absolute left-[8%] top-[27%] h-[44%] w-[38%] border transition duration-700 ${lightMode === 'contrejour' ? 'border-[#ffe6bd]/70 bg-[#060908]/48 shadow-[inset_0_0_80px_rgba(0,0,0,.86),14px_20px_70px_rgba(0,0,0,.64)' : 'border-[#f9e7ca]/36 bg-[#291e18]/22 shadow-[inset_0_0_50px_rgba(0,0,0,.4),0_12px_50px_rgba(0,0,0,.28)'}`}>
      ...
      <div className={`absolute right-[8%] top-[33%] h-[32%] w-[23%] border transition duration-700 ${lightMode === 'contrejour' ? 'border-[#fff0d2]/70 bg-[#060807]/42 shadow-[inset_0_0_62px_rgba(0,0,0,.82),-15px_10px_55px_rgba(255,194,115,.22)' : 'border-[#f9e7ca]/42 bg-[#36241b]/24 shadow-[inset_0_0_45px_rgba(0,0,0,.45),0_12px_50px_rgba(0,0,0,.28)'}`}>
    ...
    <main className="min-h-screen bg-[#0b0e0f] text-[#f6efe5] selection:bg-[#ee5e42] selection:text-[#0b0e0f]">
      ...
      <section className="relative overflow-hidden border-b border-white/12">
        ...
        <div className="mx-auto grid max-w-[1700px] gap-12 px-5 py-16 sm:px-8 sm:py-24 lg:grid-cols-[.84fr_1.16fr] lg:items-end lg:px-12 lg:py-28">
          ...
          <div className="relative border border-white/15 bg-[#15191a] p-2 shadow-[0_30px_100px_rgba(0,0,0,.35)] sm:p-3"><InteriorRoom compact lightMode={lightMode} /></div>
        </div>
      </section>
