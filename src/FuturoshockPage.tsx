...
const OPENING_WORKS: FuturoshockWork[] = [
  ...
  { id: 'fs-opening-light', title: 'chalk body', author: 'EPRIS opening study', year: '2026', format: '3d', medium: 'ceramic study', statement: 'A low-fired, chalk-white volume with a dark foot. It holds the left side of the shelf without becoming an object lesson in decoration.', openingScene: 'totem', materials: ['unglazed stoneware', 'oxide wash'], edition: 'shelf 04', room: 'room-01', shelfSlot: 4, textureNote: 'dry chalk surface, oxide base' },
  { id: 'fs-opening-orbit', title: 'nested bowl', author: 'EPRIS opening study', year: '2026', format: '3d', medium: 'ceramic study', statement: 'Two nested bowls: brown body outside, pale glaze inside. The piece is made to be read from the side first, then from above.', openingScene: 'orbit', materials: ['iron-rich clay', 'satin glaze'], edition: 'shelf 05', room: 'room-01', shelfSlot: 5, textureNote: 'satin glaze, iron-rich clay' },
  ...
  { id: 'fs-opening-signal', title: 'kiln neck', author: 'EPRIS opening study', year: '2026', format: '3d', medium: 'ceramic study', statement: 'A deliberately tall stoneware vessel, used as a vertical counterweight to the low dishes and cups around it.', openingScene: 'totem', materials: ['stoneware', 'ash glaze'], edition: 'shelf 07', room: 'room-01', shelfSlot: 7, textureNote: 'ash glaze, dark kiln foot' },
